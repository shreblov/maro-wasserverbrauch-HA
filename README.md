...
Zweimal täglich startet eine Automation mit dem gleichen Ablauf wie das Script und schreibt den aktuellen "Wasserverbrauch gesamt" in eine andere numerische Variable. Ein aktueller Wert größer gleich dem Grenzwert löst eine Benachrichtigung aus.  
...
- input_number.maro_wasserverbrauch_delta mit Minimalwert 0, Maximalwert 10, Typ Eingabefeld, Schrittweite 0,1, Maßeinheit L.  Unter Einstellungen>Werkzeuge>Zustände den Wert für input_number.maro_wasserverbrauch_delta auf 0.5 L setzen. Das kann später ggf. angepasst werden.
...
Wenn alles geklappt hat, sollte in /config/www/browserless eine Datei wasserverbrauch_Basis.json mit dem aktuellen "Wasserverbrauch gesamt" angelegt sein. 
  ...
  Optional sollte der Wert plus Delta auf dem Dashboard in der neuen Entitäten-Kachel angezeigt sein.  
